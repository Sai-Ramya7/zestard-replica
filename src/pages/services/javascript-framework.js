        ...
        <Layout>
            <div id="page" className="site ">
                <div id="content" className="site-content">
                    ...
                    />
                    {/* {data.allWordpressPage.edges[0].node.acf.sl_content_module_page.map(( node ) => ( */}
                    <div className="technology-page">
                    {acfData.sl_content_module_page.map(( node ) => (
                       <Technology 
...
{
    allWordpressPage(filter: {wordpress_id: {eq: 1495}}) {
        edges {
          node {
            slug
            acf {
